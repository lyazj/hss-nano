...
cmsDriver.py  --eventcontent NANOAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --conditions 106X_mcRun2_asymptotic_preVFP_v11 --step NANO --era Run2_2016_HIPM,run2_nanoAOD_106Xv2 --python_filename HIG-RunIISummer20UL16NanoAODAPVv12-02343_1_cfg.py --fileout file:HIG-RunIISummer20UL16NanoAODAPVv12-02343.root --filein "${FILEIN}" --mc -n "${NEVENT}" --nThreads "${NTHREAD}" --customise_commands 'process.genWeightsTable.keepAllPSWeights = True' || exit $?
xrdcp -f HIG-RunIISummer20UL16NanoAODAPVv12-02343.root "${FILEOUT}" || exit $?
